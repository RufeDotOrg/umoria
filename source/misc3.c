...
int row, column;
{
  put_buffer(&blank_string[24 - 13], row, column);
...
prt_hunger()
{
  if (PY_WEAK & py.flags.status)
    ...
    put_buffer(&blank_string[24 - 6], 23, 0);
}
...
prt_blind()
{
  if (PY_BLIND & py.flags.status)
    ...
    put_buffer(&blank_string[24 - 5], 23, 7);
}
...
prt_confused()
{
  if (PY_CONFUSED & py.flags.status)
    ...
    put_buffer(&blank_string[24 - 8], 23, 13);
}
...
prt_afraid()
{
  if (PY_FEAR & py.flags.status)
    ...
    put_buffer(&blank_string[24 - 6], 23, 22);
}
...
prt_poisoned()
{
  if (PY_POISONED & py.flags.status)
    ...
    put_buffer(&blank_string[24 - 8], 23, 29);
}
...
prt_state()
{
  ...
  if (py.flags.paralysis > 1)
    ...
    put_buffer(&blank_string[24 - 10], 23, 38);
}
...
prt_speed()
{
  ...
  if (i > 1)
    ...
    put_buffer(&blank_string[24 - 9], 23, 49);
  else if (i == -1)
...
prt_study()
{
  ...
  if (py.flags.new_spells == 0)
    put_buffer(&blank_string[24 - 5], 23, 59);
  else
...
get_name()
{
  ...
  put_buffer(&blank_string[24 - 23], 2, 15);
